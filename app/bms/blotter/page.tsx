...
export default function BMSBlotterPage() {
  ...
  return (
    <div className="p-4 sm:p-6 space-y-4 sm:space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white">BMS Blotter Records</h1>
          ...
          <DialogContent className="sm:max-w-[600px] max-h-[90vh] overflow-y-auto">
            ...
            <div className="grid gap-4 py-4">
              ...
              <div className="space-y-2">
                ...
                <Input id="contact" placeholder="Complainant's contact number" />
              </div>
              <div className="space-y-2">
            ...
            <CardContent>
              <div className="overflow-x-auto">
                <Table>
                  <TableHeader>
                    <TableRow>
                      <TableHead className="min-w-[120px]">Blotter ID</TableHead>
                      <TableHead className="min-w-[120px]">Complainant</TableHead>
                      <TableHead className="min-w-[120px]">Respondent</TableHead>
                      <TableHead className="min-w-[100px]">Incident</TableHead>
                      <TableHead className="min-w-[100px]">Date Reported</TableHead>
                          ...
                          <div className="flex items-center space-x-2">
                            <Dialog>
                              ...
                              <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
                                <DialogHeader>
                                  <DialogTitle>Blotter Details - {record.id}</DialogTitle>
                                  <DialogDescription>Complete incident information</DialogDescription>
                                </DialogHeader>
                                <div className="space-y-4">
                                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                      ...
                                      <p className="text-sm">{record.complainant}</p>
                                    </div>
                                    <div>
                                      <Label>Respondent</Label>
                                      <p className="text-sm">{record.respondent}</p>
                                    </div>
                                    <div>
                                      <Label>Contact Number</Label>
                                      <p className="text-sm">{record.contactNumber}</p>
                                    </div>
                                    <div>
                                    ...
                                    <div>
                                      ...
                                      <p className="text-sm">{new Date(record.dateIncident).toLocaleDateString()}</p>
                                    </div>
                                    <div>
                                      <Label>Date Reported</Label>
                                      <p className="text-sm">{new Date(record.dateReported).toLocaleDateString()}</p>
                                    </div>
                                    <div>
                                      <Label>Status</Label>
                                      <Badge variant={getStatusColor(record.status)}>{record.status}</Badge>
                                    ...
                                    <div>
                                      ...
                                      <p className="text-sm">{record.barangayOfficial}</p>
                                    </div>
                                  </div>
                                  <div>
